...
class crawler extends Command
{
    ...
    public function handle()
    {
        ...
        do {
            ...
            $nickNames = $this->getNicknamesFromPage($urlPage);
            ...
            foreach($nickNames as $nick) {
                $profileData = $this->getProfileData($nick, $url);
                ...
                $this->downloadImage($profileData['profileImg'], $nick);
            }
    ...
    function getProfileData($nickName, $url) {
        $profile = [];
        $content = $this->getPageContent($url . $nickName);
        if (is_null($content)){
            return null;
        }
